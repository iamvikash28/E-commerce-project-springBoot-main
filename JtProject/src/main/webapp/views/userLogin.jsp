...
<div class="login-container">
  ...
  <form action="userloginvalidate" method="post" autocomplete="off">
    <!-- Username Field -->
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        ...
        <input type="password" name="password" id="password" placeholder="Enter your password" required class="form-control form-control-lg">
        <span class="input-group-text toggle-password" id="togglePassword"><i class="fas fa-eye"></i></span>
      </div>
    </div>

    <!-- Register Link -->
    <div class="mb-3 text-center register-link">
